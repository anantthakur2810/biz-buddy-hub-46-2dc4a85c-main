      ...
      <header className="sticky top-0 z-50 border-b bg-background/95 backdrop-blur">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <Button variant="outline" className="relative" onClick={() => setActiveTab('cart')}>
            ...
            {totalItems > 0 && (<Badge className="absolute -right-2 -top-2 h-5 w-5 rounded-full p-0 text-xs">
                {totalItems}
              </Badge>)}
          </Button>
        </div>
      ...
      <main className="container mx-auto px-4 py-6">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {cartItem ? (<div className="flex items-center gap-2">
                          ...
                          </div>) : (<Button size="sm" onClick={() => addToCart(product)} disabled={isOutOfStock}>
          ...
          <TabsContent value="cart">
            {items.length === 0 ? (<div className="py-12 text-center">
                ...
                <div className="space-y-4 lg:col-span-2">
                  {items.map(({ product, quantity }) => (<Card key={product.id}>
