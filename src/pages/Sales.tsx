            ...
            <div className="grid gap-4 py-4">
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setNewSale((current) => ({ ...current, customerId: value }))}
                >
                  <SelectTrigger>
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value) => setNewSale((current) => ({ ...current, productId: value }))}
                >
                  <SelectTrigger>
              ...
              <div className="grid gap-2">
                ...
                <Select
                  ...
                  onValueChange={(value: 'cash' | 'card' | 'transfer') =>
                    setNewSale((current) => ({ ...current, paymentMethod: value }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                ...
                <Table>
                  ...
                  <TableBody>
                    {selectedSale.items.map((item) => (
                      <TableRow key={`${selectedSale.id}-${item.productId}`}>
