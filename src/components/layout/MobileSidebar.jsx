...
import { BarChart3, HelpCircle, LayoutDashboard, LogOut, Package, Settings, ShoppingCart, UserPlus, Users, } from 'lucide-react';
      ...
      <SheetContent side="left" className="w-72 border-sidebar-border bg-sidebar p-0">
        ...
        <nav className="flex-1 space-y-1 px-3 py-4">
          ...
          {visibleNavigation.map((item) => {
            ...
            return (<Link key={item.name} to={item.href} onClick={() => onOpenChange(false)} className={cn('sidebar-item', isActive && 'active')}>
