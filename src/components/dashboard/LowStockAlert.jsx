...
export function LowStockAlert() {
    ...
    return (<div className="stat-card animate-fade-in border-warning/30 bg-warning/5">
      ...
      <div className="space-y-3">
        {lowStockProducts.map((product) => (<div key={product.id} className="flex items-center justify-between rounded-lg bg-card p-3">
            <div>
