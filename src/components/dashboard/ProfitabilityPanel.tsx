  ...
  return (
    <div className="stat-card animate-fade-in">
      ...
      <div className="mt-5 space-y-3">
        ...
        {profitabilityInsights.topProducts.slice(0, 4).map((entry) => (
          <div key={entry.product.id} className="flex items-center justify-between rounded-lg border border-border bg-card p-3">
            <div>
